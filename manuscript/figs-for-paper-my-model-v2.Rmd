...
```{r first-performance}
ggplot(filter(plots, performer == 'Milkina 1970')) + 
  geom_rect(data=data.frame(xmin = 33, xmax = 45, ymin = -Inf, ymax = Inf),
              aes(xmin=xmin,xmax=xmax,ymin=ymin,ymax=ymax),
              fill = 'gray90', color = 'gray90') +
  geom_line(aes(x=measure, y=tempo), color='black') +
...
```{r two-performances}
ggplot(filter(plots, performer %in% c('Milkina 1970','Bacha 1997'))) + 
  geom_rect(data=data.frame(xmin = 33, xmax = 45, ymin = -Inf, ymax = Inf),
              aes(xmin=xmin,xmax=xmax,ymin=ymin,ymax=ymax),
              fill = 'gray90', color = 'gray90') +
  geom_line(aes(x=measure, y=tempo), color='black') +
...
filter(spline_music , performer %in% c('Milkina 1970','Bacha 1997')) %>%
...
```{r similar-perfs}
similar = c('Wasowski 1980','Rubinstein 1961','Milkina 1970','Smith 1975')
...
```{r bad-model}
ggplot(filter(plots, performer == 'Block 1995')) + 
  geom_rect(data=data.frame(xmin = 33, xmax = 45, ymin = -Inf, ymax = Inf),
              aes(xmin=xmin,xmax=xmax,ymin=ymin,ymax=ymax),
              fill = 'gray90', color = 'gray90') +
  geom_line(aes(x=measure, y=tempo), color='black') +
