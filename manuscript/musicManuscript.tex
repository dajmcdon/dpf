...
listener fails to perceive as ``wrong''. For instance, the example in figure 5.3 is an
excerpt with a single tempo marking, the solid lines represent a
possible set of intended tempi, and the dotted lines are the actual
tempi.
