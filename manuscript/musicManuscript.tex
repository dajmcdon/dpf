...
It is worth noting that according to an user study described in \citep{GuRaphael2012}, using the parameters learnt from our model could generate performances that are not clearly distinguishable from the original recording. Thus, it is meaningful to use the learnt interpretive dicisions as a faithful representations of the original recordings.
