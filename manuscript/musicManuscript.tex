...
It is reasonable to ask whether a simple model such as that proposed above is able to
...
estimation. Specifically, we are interested in whether this model
``over-smooths'' the performance, eliminating some of the useful
signal. One way to address such a question 
