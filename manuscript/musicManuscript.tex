...
\begin{algorithm}[t!]
  ...
  \begin{algorithmic}
    ...
    \FOR{$i=1$ to  $n$}
    \STATE $H = RQR^\top$ \COMMENT{Effective state variance}
...
of all 46 recordings at around 64 bpm, half the marked
tempo. The next slowest is Maryla Jonas's recording at around 84
bpm. Meanwhile, his B section is among the fastest of all the
...
miraculously) group recordings by the same pianist together: both
