...
// musicModeldynamics
List musicModeldynamics(arma::vec lt, double sig2eps, arma::vec mus, arma::vec sig2eta, arma::vec transprobs, arma::vec initialMean, arma::vec initialVariance);
RcppExport SEXP _dpf_musicModeldynamics(SEXP ltSEXP, SEXP sig2epsSEXP, SEXP musSEXP, SEXP sig2etaSEXP, SEXP transprobsSEXP, SEXP initialMeanSEXP, SEXP initialVarianceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type lt(ltSEXP);
    ...
    Rcpp::traits::input_parameter< arma::vec >::type initialMean(initialMeanSEXP);
    Rcpp::traits::input_parameter< arma::vec >::type initialVariance(initialVarianceSEXP);
    rcpp_result_gen = Rcpp::wrap(musicModeldynamics(lt, sig2eps, mus, sig2eta, transprobs, initialMean, initialVariance));
    return rcpp_result_gen;
END_RCPP
}
// beamSearch
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_dpf_musicModeldynamics", (DL_FUNC) &_dpf_musicModeldynamics, 7},
