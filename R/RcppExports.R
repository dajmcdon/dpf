...
#'                   
#' @export    
musicModeldynamics <- function(lt, mueps, sig2eps, mus, sig2eta, transprobs, muerror, initialMean, initialVariance) {
    .Call('_dpf_musicModeldynamics', PACKAGE = 'dpf', lt, mueps, sig2eps, mus, sig2eta, transprobs, muerror, initialMean, initialVariance)
}
